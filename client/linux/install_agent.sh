...
HANA_HARVEST_AUTO_PROVISION="1"
HANA_HARVEST_USER="HARVEST"
HANA_HARVEST_PASSWORD="0djKUt&xbLK0AYr"
HANA_HARVEST_USERSTORE_KEY=""
HANA_HARVEST_STATE_FILE="/var/lib/monitoring-agent/hana-harvest-provisioned"
HANA_HARVEST_FORCE_PROVISION="0"
EOF
