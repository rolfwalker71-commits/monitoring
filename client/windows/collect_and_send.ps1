...
function Get-HarvestHealthStatus {
    ...
    try {
        ...
        try {
            ...
            $extCmd.CommandText = "SELECT DISTINCT e.AddOnName, e.Version FROM [SLDModel.SLDData].[dbo].[Extensions] AS e INNER JOIN [SLDModel.SLDData].[dbo].[ExtensionDeployments] AS ed ON ed.[Id] = e.[Id]"
