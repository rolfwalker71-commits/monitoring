...
- Applikations-Version: `BUILD_VERSION` (semantisch, aktuell: **1.4.140**)
- Agent-Version: `AGENT_VERSION` (separat versioniert, aktuell: **1.4.140**)
...
|---------|-------|----------|
| 1.4.140 | 14.05.2026 | Move SAP license info from header into SAP B1 dropdown section (open when filled, closed when empty) |
