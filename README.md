...
- Applikations-Version: `BUILD_VERSION` (semantisch, aktuell: **1.4.126**)
...
|---------|-------|----------|
| 1.4.126 | 14.05.2026 | Add SAP license information extraction and display (Hardware Key, Instno, Expiration, System Nr, Customer Name, Customer No) |
