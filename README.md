...
- Applikations-Version: `BUILD_VERSION` (semantisch, aktuell: **1.4.125**)
...
|---------|-------|----------|
| 1.4.125 | 14.05.2026 | Add SAP license information extraction and display (Hardware Key, Instno, Expiration, System Nr, Customer Name, Customer No) |
